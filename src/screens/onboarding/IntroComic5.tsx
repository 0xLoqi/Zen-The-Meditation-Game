...
type IntroComicNavigationProp = StackNavigationProp<NewOnboardingStackParamList, 'IntroComic5'>; 

// Define total steps for this sequence
const TOTAL_LORE_STEPS = 5; 

const IntroComic5 = () => { // <<< Renamed component
  const navigation = useNavigation<IntroComicNavigationProp>();
  const currentStep = 5; // <<< Updated step

  const handleTap = () => {
    navigation.navigate('SummonFocusStone'); // <<< Navigate to the screen AFTER the lore sequence
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000000' }}>
      ...
      <ImageBackground
        source={require('../../../assets/images/backgrounds/onboarding/lore5.png')} // <<< Updated image
...
export default IntroComic5; // <<< Updated export 