...
type IntroComicNavigationProp = StackNavigationProp<NewOnboardingStackParamList, 'IntroComic3'>; 

// Define total steps for this sequence
const TOTAL_LORE_STEPS = 5; 

const IntroComic3 = () => { // <<< Renamed component
  const navigation = useNavigation<IntroComicNavigationProp>();
  const currentStep = 3; // <<< Updated step

  const handleTap = () => {
    navigation.navigate('IntroComic4'); // <<< Updated target
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000000' }}>
      ...
      <ImageBackground
        source={require('../../../assets/images/backgrounds/onboarding/lore3.png')} // <<< Updated image
...
export default IntroComic3; // <<< Updated export 