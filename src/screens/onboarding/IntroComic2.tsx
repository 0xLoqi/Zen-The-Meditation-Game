...
type IntroComicNavigationProp = StackNavigationProp<NewOnboardingStackParamList, 'IntroComic2'>; 

// Define total steps for this sequence
const TOTAL_LORE_STEPS = 5; 

const IntroComic2 = () => { // <<< Renamed component
  const navigation = useNavigation<IntroComicNavigationProp>();
  const currentStep = 2; // <<< Updated step

  const handleTap = () => {
    navigation.navigate('IntroComic3'); // <<< Updated target
  };
  ...
  return (
    <View style={{ flex: 1, backgroundColor: '#000000' }}>
      ...
      <ImageBackground
        source={require('../../../assets/images/backgrounds/onboarding/lore2.png')} // <<< Updated image
...
export default IntroComic2; // <<< Updated export 