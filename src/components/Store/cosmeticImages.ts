// Shared static mapping for cosmetics images
const cosmeticImages = {
  // base
  'default_base.png': require('../../../assets/images/cosmetics/base/default_base.png'),
  // headgear
...
const defaultImage = require('../../../assets/images/cosmetics/base/default_base.png');

export { cosmeticImages, defaultImage }; 